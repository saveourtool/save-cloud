...
class CloneRepositoryController(
    ...
    fun submitExecutionRequest(
        ...
        @RequestPart("file", required = false) files: Flux<FileInfoDto>,
        ...
        .flatMap {
            sendToPreprocessor(
                ...
                files.map { additionalToolsFileSystemRepository.getFileInfoByDto(it) }
            ) { newExecutionId ->
    ...
    fun executionRequestStandardTests(
        ...
        @RequestPart("file", required = true) files: Flux<FileInfoDto>,
        authentication: Authentication,

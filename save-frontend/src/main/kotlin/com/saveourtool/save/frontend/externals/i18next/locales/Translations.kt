@file:Suppress("LONG_LINE", "HEADER_MISSING_IN_NON_SINGLE_CLASS_FILE")
...
const val TOPBAR_CN = """
{
    "Demo": "样例",
    "CPG": "CPG",
    "Awesome Benchmarks": "一流的基准",
    "Try SAVE format": "尝试使用SAVE format",
    "Projects board": "项目面板",
    "Contests": "竞赛",
    "About us": "关于我们",
    "Propose vulnerability": "创建漏洞",
    "Vulnerabilities": "漏洞库",
    "Top Rating": "贡献排名",
    "Awesome Benchmarks": "一流的基准",
    "SAVE Projects list": "SAVE项目列表",
...
const val PROPOSING_VULN_EN = """
{
    ...
    "Hash must not be empty": "Hash must not be empty",
    "Please input a valid name and URL": "Please input a valid name and URL",
    "Please input a valid hash and URL": "Please input a valid hash and URL"
}
"""
...
const val PROPOSING_VULN_CN = """
{
    ...
    "Vulnerability identifier": "漏洞ID",
    "Short description": "漏洞简介",
    "Generate identifier": "生成漏洞ID",
    "Description": "漏洞描述",
    ...
    "Commit Hash": "提交哈希",
    "Project Url": "项目地址",
    "Name must not be empty": "名称不允许为空",
    "Hash must not be empty": "哈希不允许为空",
    "Please input a valid name and URL": "请输入有效的名称和地址",
    "Please input a valid hash and URL": "请输入有效的哈希和地址"
}
"""

const val WELCOME_EN = """
{

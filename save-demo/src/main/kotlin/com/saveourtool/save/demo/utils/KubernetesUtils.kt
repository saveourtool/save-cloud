...
fun KubernetesClient.startJob(demo: Demo, kubernetesSettings: KubernetesConfig) {
    val job = Job().apply {
        ...
        spec = JobSpec().apply {
            ...
            template = PodTemplateSpec().apply {
                spec = PodSpec().apply {
                    ...
                    restartPolicy = "Never"
                    containers = listOf(demoAgentContainerSpec(demo.sdk.toSdk().baseImageName(), kubernetesSettings))
                }
            }
        }
    }
...
private fun demoAgentContainerSpec(imageName: String, kubernetesSettings: KubernetesConfig) = Container().apply {

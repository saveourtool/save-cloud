...
/**
 * Abstract storage which has an init method to migrate keys from old storage to new one with updating keys
 */
abstract class AbstractMigrationKeysAndStorage<O : Any, N : Any>(

 ...
 */
const val NAME_ERROR_MESSAGE = "Please input a name that doesn't contain anything but english letters, numbers and hyphens (but not the first and the last characters)"

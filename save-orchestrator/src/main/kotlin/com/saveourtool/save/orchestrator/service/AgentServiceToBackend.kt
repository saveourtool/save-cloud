...
import com.saveourtool.save.orchestrator.sandbox.SANDBOX_PROFILE
...
class AgentServiceToBackend(
     ...
     */
    override fun saveAgentsWithInitialStatuses(agents: List<Agent>): Mono<Void> = webClientBackend
        .post()
        .uri("/addAgents")
     ...
     * @return Mono with response body
     */
    override fun updateAgentStatuses(agentStates: List<AgentStatus>): Mono<Void> = webClientBackend
        .post()
     ...
     */
    override fun checkSavedData(agentId: String): Mono<Boolean> = webClientBackend.get()
     ...
     */
    override fun updateExecution(executionId: Long, executionStatus: ExecutionStatus, failReason: String?): Mono<BodilessResponseEntity> =
     ...
     */
    @Suppress("TYPE_ALIAS")
    override fun getFinishedOrStoppedAgentsForSameExecution(agentId: String): Mono<Pair<Long, List<String>>> = webClientBackend
        .get()
     ...
     */
    override fun areAllAgentsIdleOrFinished(agentId: String): Mono<Boolean> = webClientBackend
        .get()
        .uri("/getAgentsStatusesForSameExecution?agentId=$agentId")
        .retrieve()
        .bodyToMono<AgentStatusesForExecution>()
     ...
     * @return a bodiless response entity
     */
    override fun markTestExecutionsAsFailed(agentsList: Collection<String>, status: AgentState): Mono<BodilessResponseEntity> {
    ...
    companion object {
        private val log = LoggerFactory.getLogger(AgentServiceToBackend::class.java)
    }
}

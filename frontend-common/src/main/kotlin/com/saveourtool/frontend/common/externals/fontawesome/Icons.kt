...
@JsModule("@fortawesome/free-solid-svg-icons/faDownload")
@JsNonModule
external val faDownload: FontAwesomeIconModule

@JsModule("@fortawesome/free-solid-svg-icons/faTrash")
@JsNonModule
external val faTrash: FontAwesomeIconModule

@JsModule("@fortawesome/free-solid-svg-icons/faBell")
@JsNonModule
...
@JsModule("@fortawesome/free-solid-svg-icons/faTrophy")
@JsNonModule
external val faTrophy: FontAwesomeIconModule
...
@JsModule("@fortawesome/free-solid-svg-icons/faBoxOpen")
@JsNonModule
external val faBoxOpen: FontAwesomeIconModule

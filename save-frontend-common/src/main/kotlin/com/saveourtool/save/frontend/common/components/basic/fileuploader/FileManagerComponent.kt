    ...
    val uploadFiles = useDeferredRequest {
        filesForUploading.forEach { fileForUploading ->
            val uploadedFile: FileDto = postUploadFile(
                url = "${com.saveourtool.save.frontend.common.utils.apiUrl}/files/${props.projectCoordinates}/upload",
            ...
            availableFiles.map { file ->
                li {
                    ...
                    downloadFileButton(file, FileDto::name) {
                        "${com.saveourtool.save.frontend.common.utils.apiUrl}/files/download?fileId=${it.requiredId()}"
                    }
